...
if text and text:match('رفع (.*)') and tonumber(msg.reply_to_message_id_) > 0 and Mod(msg) and GetChannelMember(msg) then   
...
if text and text:match('^رفع (.*) @(.*)') and Mod(msg) and GetChannelMember(msg) then   
